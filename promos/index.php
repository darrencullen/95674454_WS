...
class RedeemAPI {
    ...
    function __construct() {
        $this->db = new mysqli('localhost', 'root', 'RnHEMFk0', 'WebServiceTutorial');
...
ob_start(); // allows the transmission of messaging without sending the headers so a header warning doesn't occur
$api = new RedeemAPI;
$api->redeem();
